...
const navItems = {
	navHTML: {
		...
		links: {
			...
			transitions: {		title:	"CSS Transitions",							link:	"html-css/transitions.html",		id:		"nav-transitions",
								copy:	"Animations, state changes, and acceleration curves",							image:	"./assets/homepage/transitions.svg"			},
